package com.ioprogramming.handsonpractise.jsonreport;
...
public class GenerateJsonReport {
    public static void main(String[] args) {
        ...
        try (Connection connection = DriverManager.getConnection(jdbcUrl, username, password);
            ...
            String insert1 = "INSERT INTO employees VALUES (1, 'Atharva', 'atharva@example.com', 30)";
            String insert2 = "INSERT INTO employees VALUES (2, 'Amber', 'amber@example.com', 25)";
            String insert3 = "INSERT INTO employees VALUES (3, 'Ashish', 'ashish@example.com', 35)";
